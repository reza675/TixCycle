...
class PaymentService {
  ...
  Future<List<PaymentMethodModel>> getPaymentMethods() async {
    ...
    return [
      PaymentMethodModel(
          ...
          logoUrl: 'images/payment/bca.png',
      ...
      PaymentMethodModel(
          ...
          logoUrl: 'images/payment/mandiri.png',
          category: 'Transfer Bank',
          paymentInstructions:
      ...
      PaymentMethodModel(
          ...
          logoUrl: 'images/payment/bri.png',
          category: 'Transfer Bank',
          paymentInstructions:
      ...
      PaymentMethodModel(
          id: 'dana',
          name: 'Dana',
          logoUrl: 'images/payment/dana.png',
          category: 'E-Wallet',
          paymentInstructions:
      ...
      PaymentMethodModel(
          id: 'shopeepay',
          name: 'ShopeePay',
          logoUrl: 'images/payment/spay.png',
          category: 'E-Wallet',
          paymentInstructions:
      ...
      PaymentMethodModel(
          id: 'gopay',
          name: 'Gopay',
          logoUrl: 'images/payment/gopay.png',
          category: 'E-Wallet',
          paymentInstructions:
      ...
      PaymentMethodModel(
          id: 'linkaja',
          name: 'LinkAja',
          logoUrl: 'images/payment/linkaja.png',
          category: 'E-Wallet',
          paymentInstructions:
      ...
      PaymentMethodModel(
          id: 'indomaret',
          name: 'Indomaret',
          logoUrl: 'images/payment/indomaret.png',
      ...
      PaymentMethodModel(
          id: 'alfamart',
          name: 'Alfamart',
          logoUrl: 'images/payment/alfamart.png',
          category: 'Gerai Retail',
          paymentInstructions:
  ...
  Future<TransactionModel> createTransaction(
    ...
    try {
      ...
      // Convert purchasedItems to PurchasedTicketItem objects
      final List<PurchasedTicketItem> purchasedTicketsList = purchasedItems
          .map((item) => PurchasedTicketItem.fromJson(item))
          .toList();
