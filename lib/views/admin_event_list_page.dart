...
class AdminEventListPage extends GetView<AdminEventListController> {
      ...
      child: Scaffold(
        ...
        body: Obx(() {
          ...
          if (controller.events.isEmpty) {
            return const Center(child: Text("Belum ada event dibuat."));
          }
  ...
  Widget _buildEventCard(EventModel event) {
    return Container(
      ...
      decoration: BoxDecoration(
        color: c4, // Latar belakang hijau tua sesuai desain
        ...
        children: [
          ...
          Padding(
            ...
            child: Column(
              ...
              children: [
                Text(
                  event.name, // "WAKTU YANG DI NANTI"
                  style: const TextStyle(
                    color: Color(0xFFE8F5E9), // Putih kehijauan
          ...
          // Tombol Perbarui (Full Width di bawah)
          GestureDetector(
            onTap: () {
              // Navigasi ke form edit, kirim data event
              Get.toNamed(AppRoutes.UPDATE_EVENT, arguments: event);
            },
            child: Container(
              padding: const EdgeInsets.symmetric(vertical: 14),
              decoration: BoxDecoration(
                color: const Color(0xFF2E3E28), // Hijau lebih gelap untuk tombol
